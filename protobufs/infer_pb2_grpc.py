...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RunInference = channel.unary_unary(
                '/gutumanu.InferenceService/RunInference',
                request_serializer=infer__pb2.InferenceRequest.SerializeToString,
                response_deserializer=infer__pb2.InferenceResponse.FromString,
...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RunInference': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=infer__pb2.InferenceResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'gutumanu.InferenceService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('gutumanu.InferenceService', rpc_method_handlers)
...
class InferenceService(object):
    ...
    def RunInference(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            infer__pb2.InferenceResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
